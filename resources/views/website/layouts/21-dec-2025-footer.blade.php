    ...
    <footer class="footer-section">
          ...
          <section class="footer-menu">
            ...
            <ul>
              <li class="footer-links link-contact-us tablet-hide">
                <strong class="footer-heading h6">{{__('Contact Us')}}</strong>
                <div class="footer-menus-wrapper">
                  <span class="footer-links__phone-number">
                    {{$ws->contact_mobile}}
                  </span>
                  <span class="footer-links__open-time">
                    Sunday to Thursday - 09:00am to 5.00pm
                  </span>
                        ...
                        <div>
                          <div class="footer-menus-wrapper">
                            <ul>
                              ...
                              <li class="child-link">
                                <p><a class="link" href="{{ route('about') }}">{{__('About Us')}}</a></p>
                              </li>

                              <li class="child-link">
                                <p><a class="link" href="#">Delivery</a></p>
                              </li>
                            ...
                            <ul>
                              ...
                              <li class="child-link">
                                <p><a class="link" href="#">Help & FAQs</a></p>
                              </li>

                              <li class="child-link">
                                <p><a class="link" href="{{ route('press') }}">Press</a></p>
                              </li>
                              ...
                              <li class="child-link">
                                <p><a class="link" href="{{ route('html.sitemap') }}">HTML Sitemap</a></p>
                              </li>
                ...
                <div class="tablet-hide">
                  ...
                  <div class="footer-menus-wrapper">
                    <ul>
                      ...
                      <li class="child-link">
                        <p><a class="link" href="{{ route('delivery') }}">Delivery</a></p>
                      </li>

                      <li class="child-link">
                        <p><a class="link" href="{{ route('return') }}">Returns</a></p>
                      </li>
                        ...
                        <div>
                          <div class="footer-menus-wrapper">
                            <ul>
                              ...
                              <li class="child-link">
                                <p><a class="link" href="#">Ideas & Inspiration</a></p>
                              </li>

                              <li class="child-link">
                                <p><a class="link" href="#">Useful Articles</a></p>
                              </li>

                              <li class="child-link">
                                <p><a class="link" href="{{ route('buying.guide') }}">Buying Guides</a></p>
                              </li>

                              <li class="child-link">
                                <p><a class="link" href="#">Open a Trade Account</a></p>
                              </li>
                            ...
                            <ul>
                              ...
                              <li class="child-link">
                                <p><a class="link" href="#">Privacy and Cookies</a></p>
                              </li>

                              <li class="child-link">
                                <p><a class="link" href="#">Price Match</a></p>
                              </li>

                              <li class="child-link">
                                <p><a class="link" href="#">Kitchen Tiles</a></p>
                              </li>

                              <li class="child-link">
                                <p><a class="link" href="#">Bathroom Tiles</a></p>
                              </li>

                              <li class="child-link">
                                <p><a class="link" href="#">Floor Tiles</a></p>
                              </li>

                              <li class="child-link">
                                <p><a class="link" href="#">Wall Tiles</a></p>
                              </li>

                              <li class="child-link">
                                <p><a class="link" href="#">Outdoor Tiles</a></p>
                              </li>
                ...
                <div class="tablet-hide">
                  ...
                  <div class="footer-menus-wrapper">
                    ...
                    <ul>
                      ...
                      <li class="child-link">
                        <p><a class="link" href="{{ route('shop') }}">Kitchen Tiles</a></p>
                      </li>
                    ...
                    <ul>
                      ...
                      <li class="child-link">
                        <p><a class="link" href="{{ route('shop') }}">Bathroom Tiles</a></p>
                      </li>

                      <li class="child-link">
                        <p><a class="link" href="{{ route('shop') }}">Floor Tiles</a></p>
                      </li>

                      <li class="child-link">
                        <p><a class="link" href="{{ route('shop') }}">Wall Tiles</a></p>
                      </li>

                      <li class="child-link">
                        <p><a class="link" href="{{ route('shop') }}">Outdoor Tiles</a></p>
                      </li>
            ...
            <ul class="footer-social-links tablet-hide">
              <li>
                <ul class="new-social-icons">
                  ...
                  <li>
                    <a class="social-media-icon" href="https://www.instagram.com/">
                  ...
                  <li>
                    <a class="social-media-icon" href="https://wa.me/message/">
          ...
          <div class="footer-text-wrapper">
            ...
            <div class="footer-text tablet-up-hide">
              <ul class="new-social-icons">
                ...
                <li>
                  <a class="social-media-icon" href="https://www.pinterest.co.uk/">
          ...
          <div class="footer-footer-inner">
            <div class="footer-inner__copyright">
              ...
              <small class="text-body text-body--small">
                ...
                © 2025 Musafir International Superstore, All Rights Reserved
              </small>
            </div>
            <div class="footer-inner__payment-container tablet-up-hide">
              <section class="payment-icons-wrapper">
                ...
                <ul class="payment-icons">
                  ...
                  <li>
                    <svg class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" role="img" x="0" y="0" width="38"
      ...
      <section class="cookie-warning-snippet hidden hide" hidden hide>
        <div class="hide" data-cookie-warning>
          <p>We use cookies to personalise your experience</br><a href='#'><span
