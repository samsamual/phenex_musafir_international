                ...
                <div class="header-section-inner" role="banner">
                    ...
                    <nav class="header-section-inner__bottom">
                        <style>
                            ...
                            /* Additional styles for dynamic menu */
                                                            ...
                                                            <ul class="nav-second-level">
                                                                ...
                                                                <li class="child-link">
                                                                    ...
                                                                    <div class="nav-third-levels-wrapper">
                                                                        @php
                                                                            // Split subcategories into two columns
                                                                            $subCategoriesArray = $subCategories->toArray();
                                                                            $midpoint = ceil(count($subCategoriesArray) / 2);
                                                                            $firstColumn = array_slice($subCategoriesArray, 0, $midpoint);
                                                                            $secondColumn = array_slice($subCategoriesArray, $midpoint);
                                                                        @endphp

                                                                        @if(!empty($firstColumn))
                                                                            <ul class="nav-third-level">
                                                                                @foreach($firstColumn as $subCategory)
                                                                                    @php
                                                                                        $subCat = \App\Models\ProductCategory::find($subCategory['id']);
                                                                                        // Get latest 3 products for this subcategory
                                                                                        $latestProducts = \App\Models\Product::whereHas('categories', function($query) use ($subCat) {
                                                                                            $query->where('product_category_id', $subCat->id);
                                                                                        })
                                                                                        ->where('active', 1)
                                                                                    ...
                                                                                    <li>
                                                                                        <a href="{{ route('productCategory', $subCat->slug) }}" data-preloadlink="true">
                                                                                            {{ $subCat->{'name_' . app()->getLocale()} }}
                                                                                        </a>
                                                                                                    ...
                                                                                                    <div class="product-item">
                                                                                                        <a href="{{ route('productDetails', ['slug' => $product->slug]) }}">
                                                                                                            @if($product->featured_image)
                                                                                                                <img src="{{ route('imagecache', ['template'=>'thumb','filename' => $product->featured_image]) }}" 
                                                                                                                     alt="{{ $product->{'name_' . app()->getLocale()} }}"
                                                                                                                     width="30" height="30">
                                                                                                            @endif
                                                                                                            <span>{{ Str::limit($product->{'name_' . app()->getLocale()}, 20) }}</span>
                                                                                                        </a>
                                                                                                    </div>
                                                                                                @endforeach
                                                                                            </div>
                                                                        ...
                                                                        @if(!empty($secondColumn))
                                                                            <ul class="nav-third-level">
                                                                                @foreach($secondColumn as $subCategory)
                                                                                    @php
                                                                                        $subCat = \App\Models\ProductCategory::find($subCategory['id']);
                                                                                        // Get latest 3 products for this subcategory
                                                                                        $latestProducts = \App\Models\Product::whereHas('categories', function($query) use ($subCat) {
